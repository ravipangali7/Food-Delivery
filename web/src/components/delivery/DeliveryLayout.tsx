...
export default function DeliveryLayout() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <aside className="hidden md:flex md:flex-col md:fixed md:left-0 md:top-0 md:z-50 md:h-screen md:w-[260px] md:bg-sidebar md:text-sidebar-foreground md:border-r md:border-sidebar-border md:shadow-lg">
        <div className="h-[72px] flex items-center px-4 border-b border-sidebar-border shrink-0">
          <span className="text-2xl">🛵</span>
          <div className="ml-3">
            <div className="font-bold text-sidebar-primary font-display">Delivery</div>
            <div className="text-[10px] text-sidebar-foreground/50 uppercase tracking-widest">Partner dashboard</div>
          </div>
        </div>
